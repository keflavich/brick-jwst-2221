...
def makeplot(avfilts=['F182M', 'F212N'], 
    ...
    pl.savefig(f"{basepath}/paper_co/figures/N{icemol}_from212vs466_vs_AV_{avfilts[0]}-{avfilts[1]}_contour_with1182.pdf", dpi=150, bbox_inches='tight')
    pl.savefig(f"{basepath}/paper_co/figures/N{icemol}_from212vs466_vs_AV_{avfilts[0]}-{avfilts[1]}_contour_with1182.png", dpi=250, bbox_inches='tight')
    ...
    if plot_brandt:
        ...
        fig.savefig(f"{basepath}/paper_co/figures/N{icemol}_from212vs466_vs_AV_{avfilts[0]}-{avfilts[1]}_contour_with1182_Brandt.png", dpi=250, bbox_inches='tight')
