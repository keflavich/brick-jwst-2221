...
pl.figure(1, figsize=(10, 10), dpi=300)
pl.pie([0.5, 0.1666, 0.11111, 0.11111], labels=['PAHs & Dust', 'CO gas', 'CO$_2$ ice',  'Other'], labeldistance=0.4, startangle=90, rotatelabels=True, textprops={'fontsize': 8});
...
pl.figure(1, figsize=(10, 10), dpi=300)
pl.pie([0.5, 0.1666, 0.11111, 0.11111], explode=(0,0.1,0,0), labels=['PAHs & Dust', 'CO gas / H$_2$ = 1$\\times10^{-4}$', 'CO$_2$ ice', 'Other'], labeldistance=0.4, startangle=90, rotatelabels=True, textprops={'fontsize': 8});
...
pl.figure(1, figsize=(10, 10), dpi=300)
pl.pie([0.5, 0.1666, 0.11111, 0.11111], explode=(0,0.1,0,0), labels=['PAHs & Dust', 'CO ice / H$_2$ = 1$\\times10^{-4}$', 'CO$_2$ ice','Other'], labeldistance=0.4, startangle=90, rotatelabels=True, textprops={'fontsize': 8});
...
pl.figure(1, figsize=(10, 10), dpi=300)
pl.pie([0.35, 0.4166666, 0.0777777, 0.0777777, ], explode=(0,0.1,0,0), labels=['PAHs & Dust', 'CO ice / H$_2$ = 2.5$\\times10^{-4}$', 'CO$_2$ ice',  'Other'], labeldistance=0.4, startangle=160, rotatelabels=True, textprops={'fontsize': 8});
...
pl.figure(1, figsize=(10, 10), dpi=300)
pl.pie([0.5, 0.1666666, 0.1111111, 0.1111111], explode=(0,0.1,0,0), labels=['PAHs & Dust', 'CO ice / H$_2$ = 2.5$\\times10^{-4}$', 'CO$_2$ ice',  'Other'], labeldistance=0.4, startangle=90, rotatelabels=True, textprops={'fontsize': 8});
