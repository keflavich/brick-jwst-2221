...
basetable = Table.read(f'{basepath}/catalogs/crowdsource_nsky0_merged_indivexp_photometry_tables_merged_qualcuts.fits')
...
galnuc_merged.write(f'{basepath}/catalogs/GALACTICNUCLEUS_2021_merged_with_crowdsource_indivexp.fits', overwrite=True)
...
pl.savefig(f"{basepath}/paper_co/figures/ColorColorDiagrams_WithSourceMap_ALL_GN_2025.pdf", dpi=150, bbox_inches='tight')
pl.savefig(f"{basepath}/paper_co/figures/ColorColorDiagrams_WithSourceMap_ALL_GN_2025.png", dpi=150, bbox_inches='tight')
