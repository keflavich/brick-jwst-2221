...
def checkicystarsincommon_ccds(basetable):
    ...
    plot_tools.cmd(basetable=basetable, ax=ax3,
                   f1='f356w',
                   f2='f444w',
                   sel=(~sel_356_444) & (np.isnan(basetable['mag_ab_f405n']) | np.isnan(basetable['mag_ab_f466n'])),
                   selcolor='g',
                   markersize=2,
                   axlims=[-1, 3, 22, 12],
                   alpha=0.0,
    ...
    pl.scatter(
               basetable['skycoord_f410m'].dec.deg[sel_405_466 | sel_356_444],
               basetable['skycoord_f410m'].ra.deg[sel_405_466 | sel_356_444],
               c='k', s=2)
    pl.scatter(
               basetable['skycoord_f410m'].dec.deg[sel_405_466 & sel_356_444],
               basetable['skycoord_f410m'].ra.deg[sel_405_466 & sel_356_444],
