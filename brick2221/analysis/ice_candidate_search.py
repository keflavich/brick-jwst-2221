...
from brick2221.analysis.make_ccd_with_icemodels import plot_ccd_with_icemodels
...
for ii, (color1, color2, lims) in enumerate(((['F182M', 'F212N'], ['F410M', 'F466N'], (0, 3, -1.5, 1.0)),
    ...
    a_color1, a_color2, c1, c2, sel, E_V_color1, E_V_color2, tb = plot_ccd_with_icemodels(color1, color2, molids=np.arange(ice_candidate_selection.sum()),
