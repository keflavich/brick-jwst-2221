#!/bin/bash
#SBATCH --job-name=w51-F770W-PipelineMIRI
...
#SBATCH --output=/blue/adamginsburg/adamginsburg/logs/miri_phot/w51-F770W-PipelineMIRI_%j.log

# FRESH PipelineMIRI re-reduction of w51 F770W (prop 6151 obs 002).
...
# No --skip_download_for_existing: the F770W uncal is absent here (and the prior
