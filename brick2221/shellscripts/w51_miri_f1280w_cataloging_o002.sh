#!/bin/bash
#SBATCH --job-name=webb-cat-w51-F1280W-o002
...
#SBATCH --output=/blue/adamginsburg/adamginsburg/logs/miri_phot/webb-cat-w51-F1280W-o002_%j.log

# Per-obs MIRI F1280W cataloging of w51 (prop 6151) obs 002, reusing
...
rm -f F1280W/pipeline/jw06151*_mirimage_*o002_crf*satstar_catalog.fits \
      F1280W/pipeline/jw06151*_mirimage_*o002_crf*satstar_model*.fits \
      F1280W/pipeline/jw06151*_mirimage_*o002_crf*satstar_flags*.fits \
      F1280W/pipeline/jw06151*_mirimage_*o002_crf*satstar_residual*.fits 2>/dev/null
