#!/bin/bash
#SBATCH --job-name=webb-cat-F1130W-miri-joint-o001o002
...
#SBATCH --output=/blue/adamginsburg/adamginsburg/logs/miri_phot/webb-cat-F1130W-miri-joint-o001o002_%j.log

# JOINT MIRI F1130W cataloging of sickle prop 3958 obs 001 + obs 002 (2026-06-20).
...
# but the faint-star core threshold may need recal for F1130W.
...
rm -f F1130W/pipeline/jw03958*_mirimage_o00[12]_crf*satstar_catalog.fits \
