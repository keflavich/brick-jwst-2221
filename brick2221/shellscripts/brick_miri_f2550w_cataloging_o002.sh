#!/bin/bash
#SBATCH --job-name=webb-cat-brick-F2550W-o002
...
#SBATCH --output=/blue/adamginsburg/adamginsburg/logs/miri_phot/webb-cat-brick-F2550W-o002_%j.log

# Per-obs MIRI F2550W cataloging of brick (prop 2221) obs 002, reusing
...
# Canonical MIRI PSFs (fovp101/512/1024) are symlinked into brick/psfs.
...
rm -f F2550W/pipeline/jw02221*_mirimage_*o002_crf*satstar_catalog.fits \
      F2550W/pipeline/jw02221*_mirimage_*o002_crf*satstar_model*.fits \
      F2550W/pipeline/jw02221*_mirimage_*o002_crf*satstar_flags*.fits \
      F2550W/pipeline/jw02221*_mirimage_*o002_crf*satstar_residual*.fits 2>/dev/null
