#!/bin/bash
#SBATCH --job-name=webb-reduce-F1500W-miri-o001
...
#SBATCH --output=/blue/adamginsburg/adamginsburg/logs/miri_phot/webb-reduce-F1500W-miri-o001_%j.log

# Re-reduce sickle (prop 3958) MIRI F1500W obs 001 alignment + mosaic.
...
main('F1500W', Observations=Observations, regionname='sickle', field='001', proposal_id='3958', skip_step1and2=True, skip_download_for_existing=True)
"
