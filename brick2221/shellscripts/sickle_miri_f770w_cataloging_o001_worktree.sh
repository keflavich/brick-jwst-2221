#!/bin/bash
#SBATCH --job-name=webb-cat-F770W-miri-o001
...
#SBATCH --output=/blue/adamginsburg/adamginsburg/logs/miri_phot/webb-cat-F770W-miri-o001_%j.log

# Per-obs MIRI F770W cataloging of sickle (prop 3958) obs 001.
...
# in main).  The OLD o001_pruned launcher ran the MAIN repo -> never got these
# fixes -> A/B stayed unsubtracted in the o001 product.  Use the worktree here too.
...
rm -f F770W/pipeline/jw03958*_mirimage_o001_crf*satstar_catalog.fits \
      F770W/pipeline/jw03958*_mirimage_o001_crf*satstar_model*.fits \
      F770W/pipeline/jw03958*_mirimage_o001_crf*satstar_flags*.fits \
      F770W/pipeline/jw03958*_mirimage_o001_crf*satstar_residual*.fits 2>/dev/null
...
/blue/adamginsburg/adamginsburg/miniconda3/envs/python313/bin/python \
    /blue/adamginsburg/adamginsburg/repos/brick-jwst-2221/brick2221/shellscripts/make_satstar_diagnostic.py o001
