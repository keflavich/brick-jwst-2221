...
#SBATCH --job-name=brick00363_282a
pwd; hostname; date

WORK_DIR='/orange/adamginsburg/jwst/brick/alma/2021.1.00363.S/science_goal.uid___A001_X1590_X282a/group.uid___A001_X1590_X2819/member.uid___A001_X1590_X281a/calibrated/working'
...
export script=${SCRIPT_DIR}/first_pass_imaging_science_goal.uid___A001_X1590_X282a.py

export LOGFILENAME="${LOG_DIR}/casa_log_mpi_2021.1.00363.S_282a_${SLURM_JOB_ID}_$(date +%Y-%m-%d_%H_%M_%S).log"
